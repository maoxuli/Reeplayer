...
class CameraClient : public jsonrpc::Client
{
    public:
        ...
        bool switchMode(int mode) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["mode"] = mode;
            Json::Value result = this->CallMethod("switchMode",p);
            if (result.isBool())
        ...
        std::string startStreaming() throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p = Json::nullValue;
